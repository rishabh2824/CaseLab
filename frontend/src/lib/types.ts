...
export type DraftPersona = Omit<PersonaPayload, 'profile_photo' | 'files' | 'referrals'> & {
...
export const isPendingUpload = (value: File | FileRef | null | undefined): value is File => value instanceof File
...
export type PersonaFieldErrors = Partial<
    Record<'name' | 'role' | 'availability' | 'fileCount' | 'referralOutCount', string>
>
